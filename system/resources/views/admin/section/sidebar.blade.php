...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{url('public')}}/assets-admin/dist/img/buah.jpg" alt="" class="brand-image img-circle elevation-5" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{url ('public') }}/assets-admin/dist/img/hesty.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
